            ...
            <div className="flex-1 flex flex-col relative">
                {step === "date-time" ? (
                        ...
                        <div className="flex-1 p-8 overflow-y-auto flex flex-col items-center border-r border-zinc-100 dark:border-zinc-800">
                            ...
                            <div className="calendar-wrapper">
                                <DayPicker
                                    ...
                                    modifiersClassNames={{
                                        selected: "bg-brand-600 text-white hover:bg-brand-600 hover:text-white rounded-md",
                                ...
                                <div className="grid gap-2 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    {slots.map(slot => (
                                        <Button
                                            key={slot}
                                            variant="outline"
                                            className="w-full justify-center font-semibold text-brand-600 border-brand-200 hover:bg-brand-50 hover:border-brand-600 hover:text-brand-700 transition-all"
                    ...
                    <div className="flex-1 p-8 overflow-y-auto animate-in slide-in-from-right duration-300">
                        <Button variant="ghost" className="mb-6 pl-0 hover:bg-transparent hover:text-brand-600" onClick={() => setStep("date-time")}>
                        ...
                        <div className="max-w-md mx-auto space-y-6">
                            ...
                            <Button className="w-full bg-brand-600 hover:bg-brand-700 h-11 text-base font-semibold" onClick={handleSubmit} disabled={isSubmitting}>
