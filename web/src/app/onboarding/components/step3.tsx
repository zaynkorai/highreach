    ...
    return (
        <div className="space-y-8 text-center animate-in fade-in zoom-in-95 duration-700">
            <div className="relative">
                ...
                <div className="relative w-24 h-24 bg-brand-600 rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-brand-500/40 rotate-12 group hover:rotate-0 transition-all">
            ...
            <div className="space-y-3">
                ...
                <p className="text-zinc-500 dark:text-zinc-400 font-medium">Your personal HighReach workspace is ready for liftoff.</p>
            </div>
