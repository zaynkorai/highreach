...
export function PublicForm({ form }: PublicFormProps) {
    ...
    const theme = form.theme || {
        primaryColor: "#FF2D55", // Updated fallback primaryColor
    ...
    return (
        ...
        >
            ...
            <div className="mt-8 flex items-center gap-2 opacity-60 group/logo">
                ...
                <span className="text-xs text-zinc-400 font-medium">Powered by HighReach</span>
            </div>
        </div>
    );
}
