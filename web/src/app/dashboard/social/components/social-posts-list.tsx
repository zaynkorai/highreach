                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-1.5 flex-wrap">
                                            ...
                                            {post.settings?.commentToLead?.enabled && (
                                                <Badge
                                                    variant="outline"
                                                    className="text-[10px] bg-purple-500/10 text-purple-600 border-purple-500/20 font-medium"
                                                >
                                                    ⚡️ Lead Magnet
                                                </Badge>
                                            )}
                                            {post.settings?.evergreen?.enabled && (
                                                <Badge
                                                    variant="outline"
                                                    className="text-[10px] bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-medium"
                                                >
                                                    🔁 Evergreen ({post.settings.evergreen.recyclesCount || 0}/{post.settings.evergreen.maxRecycles === 0 ? "∞" : post.settings.evergreen.maxRecycles})
                                                </Badge>
                                            )}
                                            {post.settings?.carousel?.enabled && (
                                                <Badge
                                                    variant="outline"
                                                    className="text-[10px] bg-sky-500/10 text-sky-600 border-sky-500/20 font-medium"
                                                >
                                                    📄 Carousel ({post.settings.carousel.slides?.length || 0} slides)
                                                </Badge>
                                            )}
                                        </div>
