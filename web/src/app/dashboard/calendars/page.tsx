                ...
                <div className="flex flex-col gap-4 w-full md:w-auto">
                    ...
                    <Tabs value={view} onValueChange={setView} className="w-full md:w-auto mt-2">
                        <TabsList className="bg-transparent p-0 gap-6 justify-start h-auto">
                            <TabsTrigger
                                value="scheduling"
                                className="pl-0 pr-0 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-brand-600 data-[state=active]:text-brand-600 rounded-none h-9 font-bold text-zinc-500 hover:text-brand-600 transition-colors"
                            >
                                Scheduling
                            </TabsTrigger>
                            <TabsTrigger
