...
const initialEdges: Edge[] = [
    { id: "e1-2", source: "1", target: "2", type: "smoothstep", animated: true, style: { stroke: "var(--color-brand-600)" }, markerEnd: { type: MarkerType.ArrowClosed, color: "var(--color-brand-600)" } },
