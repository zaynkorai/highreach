        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-brand-500 hover:bg-brand-600 text-white rounded-lg text-sm font-medium transition-all shadow-sm shadow-brand-500/20 flex items-center gap-2 active:scale-95"
                >
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/[0.08] rounded-2xl p-5 shadow-sm">
                    ...
                    <div className="text-2xl font-bold text-brand-600 dark:text-brand-400">{avgConversion}</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {forms.map((form) => (
                    <Link key={form.id} href={`/dashboard/forms/${form.id}`} className="block">
                        <div className="group h-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/[0.08] rounded-2xl overflow-hidden hover:border-brand-500/30 transition-all shadow-sm hover:shadow-md dark:shadow-none cursor-pointer flex flex-col">
                            <div className="p-6 border-b border-zinc-100 dark:border-white/[0.08] group-hover:bg-brand-50/10 transition-colors flex-1">
                                <div className="flex justify-between items-start mb-4">
                                    <div className={form.status === "active"
                                ...
                                <h3 className="text-lg font-bold text-foreground mb-1 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">{form.name}</h3>
