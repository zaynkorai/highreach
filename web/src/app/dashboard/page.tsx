...
function ActionCard({ icon, title, description, href }: { icon: React.ReactNode; title: string; description: string; href: string }) {
    return (
        <Link
            href={href}
            className="group bg-zinc-50 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.08] rounded-xl p-4 hover:border-brand-500/30 hover:bg-brand-50/50 dark:hover:bg-brand-500/5 transition-all cursor-pointer"
        >
            <div className="text-brand-600 dark:text-brand-400 mb-3 group-hover:scale-110 transition-transform">
                {icon}
            </div>
