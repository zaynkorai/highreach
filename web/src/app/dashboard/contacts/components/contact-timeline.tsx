            ...
            <div className="p-1 mb-4">
                <div className="relative">
                    <Textarea
                        ...
                        className="min-h-[80px] pr-12 resize-none bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 focus-visible:ring-brand-500"
                    ...
                    <Button
                        size="icon"
                        variant="ghost"
                        className="absolute bottom-2 right-2 h-8 w-8 hover:bg-brand-50 hover:text-brand-600 dark:hover:bg-brand-500/10 dark:hover:text-brand-400"
