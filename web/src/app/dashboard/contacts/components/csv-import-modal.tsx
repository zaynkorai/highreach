                    ...
                    {!result ? (
                        <>
                            <div className="border-2 border-dashed border-zinc-200 dark:border-zinc-700 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors cursor-pointer relative">
                                ...
                                />
                                <div className="w-12 h-12 bg-brand-100 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-full flex items-center justify-center mb-3">
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-brand-500 hover:bg-brand-600 text-white font-medium py-2.5 rounded-lg transition-colors text-sm shadow-sm opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                        ...
                        <div className="text-center space-y-6 flex flex-col max-h-[70vh]">
                            <div className="shrink-0 space-y-4">
                                <div className="w-16 h-16 bg-brand-100 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 rounded-full flex items-center justify-center mx-auto">
                                ...
                                <div className="flex justify-center gap-6 text-sm">
                                    <div className="flex flex-col">
                                        <span className="text-2xl font-bold text-brand-600 dark:text-brand-400">{result.success}</span>
                            ...
                            <button
                                onClick={onClose}
                                className="shrink-0 w-full bg-brand-500 hover:bg-brand-600 text-white font-medium py-2.5 rounded-lg transition-colors text-sm shadow-sm"
                            >
                                Done
                            </button>
                        </div>
