            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm dark:shadow-none">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-zinc-500 dark:text-zinc-400">Start your 14-day free trial</p>
                    </div>
                    ...
                    <div className="mt-6 text-center text-sm text-zinc-500 dark:text-zinc-400">
                        ...
                        <Link href="/login" className="text-emerald-500 dark:text-emerald-400 hover:text-emerald-400 dark:hover:text-emerald-300 font-medium">
                            Sign in
                        </Link>
                    </div>
                </div>
