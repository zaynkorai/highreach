        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg text-sm font-medium transition-all shadow-sm shadow-indigo-500/20 flex items-center gap-2 active:scale-95"
                >
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/[0.08] rounded-2xl p-5 shadow-sm">
                    ...
                    <div className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{avgConversion}</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {forms.map((form) => (
                    <Link key={form.id} href={`/dashboard/forms/${form.id}`} className="block">
                        <div className="group h-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/[0.08] rounded-2xl overflow-hidden hover:border-indigo-500/30 transition-all shadow-sm hover:shadow-md dark:shadow-none cursor-pointer flex flex-col">
                            <div className="p-6 border-b border-zinc-100 dark:border-white/[0.08] group-hover:bg-indigo-50/10 transition-colors flex-1">
                                ...
                                <h3 className="text-lg font-bold text-foreground mb-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{form.name}</h3>
                ...
                <button
                    onClick={() => setIsCreateOpen(true)}
                    className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-2xl hover:border-indigo-500/50 hover:bg-indigo-50/30 dark:hover:bg-indigo-500/5 transition-all group h-full min-h-[220px]"
                >
                    <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-400 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-500/20 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 flex items-center justify-center mb-4 transition-colors">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
