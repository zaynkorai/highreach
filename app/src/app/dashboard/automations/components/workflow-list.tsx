...
const WorkflowCard = memo(({ workflow, onEdit, onDelete }: { workflow: Workflow, onEdit: (id: string) => void, onDelete: (id: string, name: string) => void }) => {
    return (
        <div
            ...
            className="group flex flex-col justify-between p-5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-indigo-500/50 hover:shadow-lg transition-all duration-300 relative overflow-hidden cursor-pointer"
        >
            ...
            <div className="space-y-4">
                <div className="flex items-start justify-between">
                    <div className={`p-2.5 rounded-lg ${workflow.status === 'published' ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500'}`}>
            ...
            <div className="absolute bottom-4 right-4 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-200 z-10 pointer-events-none">
                <Button size="icon" className="rounded-full shadow-lg bg-indigo-600 hover:bg-indigo-700 h-8 w-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="p-2 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 rounded-lg"><Zap className="w-4 h-4" /></div>
                    </div>
                </div>
                <div className="p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="p-2 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 rounded-lg"><Activity className="w-4 h-4" /></div>
                    </div>
                </div>
                <div className="p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="p-2 bg-amber-50 dark:bg-amber-500/10 text-amber-600 rounded-lg"><Edit3 className="w-4 h-4" /></div>
                    </div>
                </div>
            </div>
