                        ...
                        {steps.map((step, index) => (
                            <div key={step.id} className="relative">
                                ...
                                <div className="flex items-start gap-4 p-4 bg-zinc-50 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800">
                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${step.type === 'trigger' ? 'bg-indigo-100 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400' :
