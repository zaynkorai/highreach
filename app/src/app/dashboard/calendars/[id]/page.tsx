        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8 pb-24 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={handleSave} disabled={isSaving} className="bg-indigo-600 hover:bg-indigo-700 font-bold min-w-[140px]">
            ...
            <Tabs defaultValue="general" className="w-full">
                ...
                <TabsContent value="schedule" className="space-y-6">
                    ...
                    <Card className="shadow-md border-indigo-100 dark:border-indigo-900/20">
