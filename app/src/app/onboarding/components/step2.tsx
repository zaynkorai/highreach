                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    selectedRole === role.id
                                        ? "border-indigo-600 bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 shadow-sm"
                                        : "border-zinc-200 dark:border-white/10 hover:border-zinc-300 dark:hover:border-white/20 text-zinc-600 dark:text-zinc-400"
                                )}
                            >
                                <div className={cn(
                                    "w-10 h-10 rounded-xl flex items-center justify-center transition-colors",
                                    selectedRole === role.id ? "bg-indigo-600 text-white" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-400"
                                )}>
