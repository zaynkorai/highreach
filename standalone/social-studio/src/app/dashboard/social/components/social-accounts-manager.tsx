...
import { ClientConnectModal } from "./client-connect-modal";
...
const CHANNEL_CONFIGS: {
    ...
    },
    {
        ...
        description: "Schedule updates, discussion prompts, and lesson posts to your Skool groups.",
        icon: "🎒",
        brandColor: "#F59E0B",
    },
    {
        ...
        description: "Publish product announcements and member perks to Whop communities.",
        icon: "🟠",
        brandColor: "#FF5C35",
    },
];
...
export function SocialAccountsManager() {
    ...
    const { open: openClientConnect } = useSocialClientConnect();
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-xs">
                ...
                <div className="flex items-center gap-2">
                    <Button
                        size="sm"
                        variant="outline"
                        onClick={openClientConnect}
                        className="text-xs font-bold gap-1.5 border-brand-500/30 text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-950/40 shadow-xs"
                    >
